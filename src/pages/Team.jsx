      ...
      <div className="max-w-7xl mx-auto px-4 py-16">
        <section className="mb-20">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 perspective-1000">
            {teamData.coreCommittee.map((member, index) => (
              <div
                key={member.id}
              ...
              >
                ...
                <div className="relative z-10">
                  <div className="w-32 h-32 olympic-gold rounded-full mx-auto mb-6 flex items-center justify-center text-gray-900 text-4xl font-black overflow-hidden shadow-2xl border-4 border-white animate-float">
                    {member.photo ? (
                      <img
                        src={member.photo}
                        alt={member.name}
        ...
        <section className="mb-20">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 perspective-1000">
            {teamData.sportsCoordinators.map((member, index) => (
              <div
                key={member.id}
              ...
              >
                ...
                <div className="relative z-10">
                  <div className="w-28 h-28 olympic-silver rounded-full mx-auto mb-4 flex items-center justify-center text-gray-900 text-3xl font-black overflow-hidden shadow-2xl border-4 border-white animate-float">
                    {member.photo ? (
                      <img
                        src={member.photo}
                        alt={member.name}
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-3xl mx-auto perspective-1000">
            {teamData.webTeam.map((member) => (
              ...
              >
                ...
                <div className="relative z-10">
                  <div className="w-32 h-32 olympic-bronze rounded-full mx-auto mb-6 flex items-center justify-center text-gray-900 text-4xl font-black overflow-hidden shadow-2xl border-4 border-white animate-float">
                    {member.photo ? (
                      <img
                        src={member.photo}
                        alt={member.name}
